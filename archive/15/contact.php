...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<p class='h1 responsive-txt uber mb0'>Message sent successfully</p>";
	echo "<p class='h2 responsive-txt serif italic text-light'>Thank you $name, your message has been submitted to us.</p>";
	echo "</div>";
	echo "</fieldset>";
